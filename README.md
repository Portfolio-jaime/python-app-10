...
```sh
helm install python-app-10 ./charts/python-app-10 \
  --set image.repository=jaimehenao8126/python-app-10 \
  --set image.tag=<tag>
```

- Ingress por defecto: `python-app-10.test.com`
...
- [charts/python-app-1/](./charts/python-app-10/): Helm chart y valores
